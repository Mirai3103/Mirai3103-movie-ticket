...
btnSaveModalBanner.addEventListener('click', function() {
...
var btnCloseModalDetailBanner = document.getElementById('btn-close-modal-detail-banner');
btnCloseModalDetailBanner.addEventListener('click', function() {
    if (modalDetailBanner) {
        txtChooseDetailBanner.value = "";
        txtLinkDetailBanner.value = "";
        $(modalDetailBanner).modal('hide');
    }
});

// btn delete detail banner
var btnDeleteDetailBanner = document.getElementById('btn-delete-modal-detail-banner');
btnDeleteDetailBanner.addEventListener('click', function() {
    $(modalDetailBanner).modal('hide');
});

// btn cancel detail banner
var btnCancelDetailBanner = document.getElementById('btn-cancel-modal-detail-banner');
...
// btn save detail banner
var btnSaveDetailBanner = document.getElementById('btn-save-modal-detail-banner');
btnSaveDetailBanner.addEventListener('click', function() {
    $(modalDetailBanner).modal('hide');
});