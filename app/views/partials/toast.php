<template x-teleport="body" x-init="
...
">
    <ul x-data="{ 
                ...
                burnToast(id){
                    ...
                    if(burnToastElement){
                        if(this.toasts.length == 1){
                            ...
                            burnToastElement.classList.remove('tw-translate-y-0');
                            if(this.position.includes('bottom')){
                                burnToastElement.classList.add('tw-translate-y-full');
                            } else {
                                burnToastElement.classList.add('tw--translate-y-full');
                            }
                            burnToastElement.classList.add('tw--translate-y-full');
                        }
                        burnToastElement.classList.add('tw-opacity-0');
                        let that = this;
                        setTimeout(function(){
                ...
                positionToasts(){
                    ...
                    burnToast.firstElementChild.classList.remove('tw-opacity-100');
                    burnToast.firstElementChild.classList.add('tw-opacity-0');
        ...
        <template x-for="(toast, index) in toasts" :key="toast.id">
            <li :id="toast.id" x-data="{
                        ...
                        if(position.includes('bottom')){
                            ...
                            $el.firstElementChild.classList.add('tw-opacity-0', 'tw-translate-y-full');
                        } else {
                            $el.firstElementChild.classList.add('tw-opacity-0', 'tw--translate-y-full');
                        }
                        setTimeout(function(){
                            ...
                            setTimeout(function(){
                                if(position.includes('bottom')){
                                    $el.firstElementChild.classList.remove('tw-opacity-0', 'tw-translate-y-full');
                                } else {
                                    $el.firstElementChild.classList.remove('tw-opacity-0', 'tw--translate-y-full');
                                }
                                $el.firstElementChild.classList.add('tw-opacity-100', 'tw-translate-y-0');
                        ...
                        setTimeout(function(){
                            setTimeout(function(){
                                $el.firstElementChild.classList.remove('tw-opacity-100');
                                $el.firstElementChild.classList.add('tw-opacity-0');
                                if(toasts.length == 1){
                                    $el.firstElementChild.classList.remove('tw-translate-y-0');
                                    $el.firstElementChild.classList.add('tw--translate-y-full');
                                }
                                setTimeout(function(){
