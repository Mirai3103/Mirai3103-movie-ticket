...
?>
<link rel="stylesheet" href="/public/thong-ke/home.css">
<link rel="stylesheet" href="/public/thong-ke/detailsAnalyticsMovie.css">
            <div
                style="flex-grow: 1; flex-shrink: 1; overflow-y: auto ; max-height: 100vh;"
                class="wrapper p-5">
                <div
                    class="detail-analytics-movies container-fluid bg-white border_radius-16">
                    <!-- poster và tên phim -->
                    <div class="row">
                        <div class="col-12 p-0">
                            <div
                                class="container-fluid d-flex flex-grow-1 bg_header p-4">
                                <div>
                                    <img
                                        src="https://cinestar.com.vn/pictures/Cinestar/02-2024/thanh-guom-diet-quy.jpg"
                                        alt width="200">
                                </div>
                    ...
                    <div class="movie-analytics row my-4 px-4">
                        <div class="col-4 ps-0">
                            <div
                                class="container shadow border_radius-16 p-4">
                        ...
                        <div class="container px-4 pb-4">
                            ...
                            <div class="fs-6 fw-normal">
                                ...
                                <span><strong class="fw-semibold">Ngôn
                                    ...
                                    Anh</span><br>
                                <span><strong
                                        class="fw-semibold">Rated:</strong>
                                    K</span><br>
